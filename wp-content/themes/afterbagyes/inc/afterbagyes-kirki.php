...
function _header_footer_fields( $fields ) {
	...
	$fields[] = array(
		'type'     => 'text',
		'settings' => 'afterbagyes_footer_contact_title',
		'label'    => esc_html__( 'Footer Contact Title', 'afterbagyes' ),
	...
	$fields[] = array(
		'type'     => 'textarea',
		'settings' => 'afterbagyes_footer_contact_desc',
		'label'    => esc_html__( 'Footer Contact Description', 'afterbagyes' ),
		'default'  => '<p>afterbagyes <br> info@afterbagyes.nl</p><p>Schapedonk 6 <br> 4942 CE, Raamsdonksveer</p><p>KvK <br> BTW</p>',
		'section'  => 'footer_setting',
		'priority' => 10,
	);
	...
	$fields[] = array(
		'type'     => 'text',
		'settings' => 'afterbagyes_footer_menu_title',
		'label'    => esc_html__( 'Footer Menu Title', 'afterbagyes' ),
		'default'  => 'About',
		'section'  => 'footer_setting',
		'priority' => 10,
	);
	...
	$fields[] = array(
		...
		'label'    => esc_html__( 'Footer Social Title', 'afterbagyes' ),
		'default'  => 'Follow',
		'section'  => 'footer_setting',
		'priority' => 10,
	);
